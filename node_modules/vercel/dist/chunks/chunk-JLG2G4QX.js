...
var tokensSubcommand = {
  ...
  options: [
    ...
    },
    {
      ...
      argument: "TOKEN",
      deprecated: false,
      description: "Revoke one or more token strings (repeatable). Requires `--yes` in non-interactive mode"
    }
  ],
  examples: []
};
...
var tokensCommand = {
  ...
  arguments: [],
  subcommands: [addSubcommand11, listSubcommand14, removeSubcommand11],
  options: [],
  examples: []
};
